    ...
    @if ($step == 1)
        <form wire:submit.prevent="openForm">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4  w-full gap-5">
                <x-shared.image-radio id="wardrobe_type_hinged" name="wardrobe_type"
                    src="{{ asset('images/fiddy/wardrobe/hinged.png') }}" wire:model.live="wardrobe_type" value="hinged" />
                <x-shared.image-radio id="wardrobe_type_sliding" name="wardrobe_type"
                    src="{{ asset('images/fiddy/wardrobe/sliding.png') }}" wire:model.live="wardrobe_type"
                    value="sliding" />
            </div>
            <div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4  w-full gap-5">
                <x-shared.image-radio id="finish_type_acrylic" name="finish_type"
                    src="{{ asset('images/fiddy/wardrobe/acrylic.png') }}" wire:model.live="finish_type"
                    value="acrylic" />
                <x-shared.image-radio id="finish_type_laminate" name="finish_type"
                    src="{{ asset('images/fiddy/wardrobe/laminate.png') }}" wire:model.live="finish_type"
                    value="laminate" />
                <x-shared.image-radio id="finish_type_glass" name="finish_type"
                    src="{{ asset('images/fiddy/wardrobe/glass.png') }}" wire:model.live="finish_type" value="glass" />
            </div>
            <div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4  w-full gap-5">
                <x-shared.image-radio id="material_mdf" name="material"
                    src="{{ asset('images/fiddy/wardrobe/mdf.png') }}" wire:model.live="material" value="MDF" />
                <x-shared.image-radio id="material_hdhmr" name="material"
                    src="{{ asset('images/fiddy/wardrobe/hdhmr.png') }}" wire:model.live="material" value="HDHMR" />
                <x-shared.image-radio id="material_waterproof_ply" name="material"
                    src="{{ asset('images/fiddy/wardrobe/waterproof_ply.png') }}" wire:model.live="material"
                    value="Waterproof Ply" />
            </div>
            <div>
            ...
            <div class="grid grid-cols-3 gap-3 sm:gap-5">
                <div class="flex flex-col gap-1">
                    ...
                    <x-shared.text-input class="text-sm !bg-white shadow-sm" id="width" type="number" required
                        step="0.1" min="1" name="width" wire:model="width" placeholder="Width" />
                    <x-input-error for="width" class="mt-2" />
                </div>
                <div class="flex flex-col gap-1">
                    <label for="height" class="text-sm">Height (ft)</label>
                    <x-shared.text-input class="text-sm !bg-white shadow-sm" id="length" type="number" required
                        step="0.1" min="1" name="height" wire:model="height" placeholder="Height" />
