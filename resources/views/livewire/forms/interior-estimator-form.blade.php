    ...
    <form wire:submit.prevent="next">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-5">
            <div class="flex flex-col gap-1">
                ...
                <x-shared.text-input class="text-sm" id="bedrooms" type="number" required step="1" min="0" max="5" name="bedrooms" wire:model="bedrooms" placeholder="Bedrooms" />
                <x-input-error for="bedrooms" class="mt-2" />
            </div>
            <div class="flex flex-col gap-1">
                <label for="livings" class="text-sm">No. of Living: rooms</label>
                <x-shared.text-input class="text-sm" id="livings" type="number" required step="1" min="0" max="5" name="livings" wire:model="livings" placeholder="Livings" />
                <x-input-error for="livings" class="mt-2" />
            </div>
            <div class="flex flex-col gap-1">
                <label for="kitchens" class="text-sm">No. of Kitchens:</label>
                <x-shared.text-input class="text-sm" id="kitchens" type="number" required step="1" min="0" max="5" name="kitchens" wire:model="kitchens" placeholder="Kitchens" />
                <x-input-error for="kitchens" class="mt-2" />
            </div>
            <div class="flex flex-col gap-1">
                <label for="dinings" class="text-sm">No. of Dinings:</label>
                <x-shared.text-input class="text-sm" id="dinings" type="number" required step="1" min="0" max="5" name="dinings" wire:model="dinings" placeholder="Dinings" />
                <x-input-error for="dinings" class="mt-2" />
            </div>
            <div class="flex flex-col gap-1">
                <label for="bathrooms" class="text-sm">No. of Bathrooms:</label>
                <x-shared.text-input class="text-sm" id="bathrooms" type="number" required step="1" min="0" max="5" name="bathrooms" wire:model="bathrooms" placeholder="Bathrooms" />
