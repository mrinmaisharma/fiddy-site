...
<div class="mb-2" x-data="{{ json_encode(['show' => true, 'style' => $style, 'message' => $message]) }}"
    :class="{
        'bg-success/80': style == 'success',
    ...
    x-on:banner-message.window="
                ...
                show = true;
            ">
    <div class="max-w-screen-xl mx-auto py-2 px-3 sm:px-2 lg:px-2">
        <div class="flex items-center justify-between flex-wrap">
            <div class="w-0 flex-1 flex items-center min-w-0">
                <span class="flex p-2 rounded-lg"
                    :class="{ 'bg-success': style == 'success', 'bg-red-600': style == 'danger' }">
                ...
                <p class="ms-3 font-medium text-sm text-white text-wrap" x-text="message"></p>
            </div>

            <div class="shrink-0 sm:ms-3">
                <button type="button" class="-me-1 flex p-2 rounded-md focus:outline-none sm:-me-2 transition"
                    :class="{
                        'hover:bg-success focus:bg-success': style ==
                            'success',
