<x-guest-layout>
  ...
  <main>
    <div class="flex flex-col items-center lg:px-32 sm:px-5">
      <div class="relative w-full h-[330px] bg-no-repeat bg-center" style="background-image:url('{{ asset('images/fiddy/about/about-us-main.jpeg') }}')">
        <p class="absolute flex text-white font-bold text-3xl pl-2 mt-[280px]">
          Our Journey
        </p>
      </div>
      <div class="mt-6">
        <p class="font-bold text-gray-900  dark:text-gray-800">
        ...
        <br/>
        <p class="text-gray-900  dark:text-gray-800">
    ...
    <div class="bg-[#F6F5F3] py-8 w-full mt-10 rounded-md">
      <div class="flex flex-col items-center gap-1">
        ...
        <div class="my-4 flex-col px-4 md:px-10 lg:px-20 xl:px-32">
          <div class="flex flex-col gap-8  md:flex-row py-8 pb-8">
            <div class="bg-[#FBFAF9] hover:bg-white shadow-md transition-shadow duration-300 hover:shadow-2xl flex-col items-center px-10 md:px-10 w-full">
              <div class="px-6 md:px-10 md:gap-8 py-10 flex-col gap-8">
                ...
                <p class="md:text-[#727272] text-sm mt-4">
          ...
          <div class="flex flex-col gap-8 md:flex-row py-8 pb-8">
            ...
            <div class="bg-[#FBFAF9] hover:bg-white shadow-md transition-shadow duration-300 hover:shadow-2xl flex-col items-center px-10 md:px-10 w-full">
              <div class="px-6 md:px-10 md:gap-8 py-10 flex-col gap-8">
                <img src="{{ asset('images/fiddy/about/durability-about-us.png') }}" alt="durability-logo"
                class="w-16" />
                <h2 class="text-lg md:text-xl mt-4 text-[#252525">
                  Durability
                </h2>
      ...
      <div>
        ...
        <div class="flex-wrap flex mt-10 gap-5 justify-center">
          ...
          style="background-image:url('{{ asset('images/fiddy/about/co-founder-1-about-us.jpeg') }}')">
            <p class="absolute flex mt-[510px] justify-center inset-0 text-[#F5C93C] text-xl font-bold group-hover:mt-[450px] ease-in duration-300">
              Ar. Amol Srivastava
            </p>
            <p class="absolute flex mt-[550px] justify-center opacity-0 inset-0 text-white text-base font-bold group-hover:mt-[500px] ease-in duration-300 group-hover:opacity-100">
              Co-Founder
            </p>
          </div>
          <div class="group w-[500px] h-[600px] bg-cover bg-no-repeat bg-center hover:bg-left ease-in duration-150 relative"
