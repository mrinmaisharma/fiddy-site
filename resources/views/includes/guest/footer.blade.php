    ...
    <div class="max-w-screen-lg px-5 lg:px-2 py-10 grid sm:grid-cols-3 grid-cols-1 mx-auto gap-5">
        ...
        <div class="">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 mt-5 text-xs gap-5">
                ...
                <a href="https://www.fiddy.in/studio/" class="hover:underline underline-offset-2 sm:col-span-2">About
                    Us</a>
                <a href="https://www.fiddy.in/products/" class="hover:underline underline-offset-2">Our Products</a>
                <a href="https://www.fiddy.in/contact/" class="hover:underline underline-offset-2 sm:col-span-2">Contact
                    Us</a>
        ...
        <div>
            ...
            <div class="mt-5 flex flex-wrap gap-2 text-gray-300">
                <a href="#"
                    class="inline-flex items-center justify-center w-8 h-8 rounded-full border-[1px] border-gray-300 hover:text-white hover:bg-[#5E6D7E]">
