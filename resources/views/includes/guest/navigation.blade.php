    ...
    <div class="max-w-screen-xl px-5 lg:px-20 py-2 flex justify-between text-[0.7rem] text-white mx-auto">
        ...
        <div class="flex gap-2">
            <div class="flex flex-wrap gap-2 text-gray-300">
                <a href="#"
                    class="inline-flex items-center justify-center w-6 h-6 rounded-full border-[1px] border-gray-300 hover:text-white hover:bg-[#5E6D7E]">
                    <x-ri-facebook-fill class="w-3 h-3" />
                </a>
                <a href="#"
                    class="inline-flex items-center justify-center w-6 h-6 rounded-full border-[1px] border-gray-300 hover:text-white hover:bg-[#5E6D7E]">
                    <x-ri-twitter-fill class="w-3 h-3" />
                </a>
                <a href="#"
                    class="inline-flex items-center justify-center w-6 h-6 rounded-full border-[1px] border-gray-300 hover:text-white hover:bg-[#5E6D7E]">
                    <x-ri-linkedin-fill class="w-3 h-3" />
                </a>
                <a href="#"
                    class="inline-flex items-center justify-center w-6 h-6 rounded-full border-[1px] border-gray-300 hover:text-white hover:bg-[#5E6D7E]">
                    <x-ri-instagram-line class="w-3 h-3" />
                </a>
            </div>
        </div>
    </div>
...
<nav x-data="{ mobile_menu: false }" class="bg-white border-gray-200 dark:bg-white h-16 md:h-auto shadow shadow-gray-700/10">
    <div class="max-w-screen-xl px-5 lg:px-[4.6rem] flex flex-wrap items-center justify-between mx-auto py-1">
        ...
        <button @click="mobile_menu=!mobile_menu" data-collapse-toggle="navbar-default" type="button"
            ...
            <svg x-bind:class="{ 'hidden': mobile_menu == true, '': mobile_menu == false }" class="w-5 h-5"
                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 17 14">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M1 1h15M1 7h15M1 13h15" />
            </svg>
            <svg x-bind:class="{ '': mobile_menu == true, 'hidden': mobile_menu == false }"
        ...
        <div class="z-10 w-full md:!scale-y-100 block md:w-auto overflow-hidden origin-top ease-linear duration-200"
            x-bind:class="{ 'scale-y-100': mobile_menu == true, 'scale-y-0': mobile_menu == false }"
            id="navbar-default">
            <ul
